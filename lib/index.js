...
const COMMON = styledSystem.compose(styledSystem.display, styledSystem.space, styledSystem.color);
const BORDER = styledSystem.compose(styledSystem.border, styledSystem.shadow);
const LAYOUT = styledSystem.compose(styledSystem.width, styledSystem.height, styledSystem.minWidth, styledSystem.minHeight, styledSystem.maxWidth, styledSystem.maxHeight, styledSystem.verticalAlign, styledSystem.overflow, styledSystem.overflowX, styledSystem.overflowY);
const TYPOGRAPHY = styledSystem.typography;
...
createStyled("div", {
  ...
  target: "ed73l3l0",
  label: "Box"
})(styledSystem.compose(COMMON, BORDER, TYPOGRAPHY, LAYOUT, POSITION, FLEX, GRID), process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
...
const borderShadowColor = polished.rgba(colors.gray[7], 0.15); // Used to be colors.neutral['80A'] in v3 and down.

const blurryShadowColor = polished.rgba(colors.gray[5], 0.3); // Used to be colors.neutral['50A'] in v3 and down.
