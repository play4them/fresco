...
var Avatar = function Avatar(_ref) {
  var bg = _ref.bg,
      ...
      name = _ref.name,
      size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["bg", "borderRadius", "color", "image", "name", "size"]);
...
var Dialog$1 = function Dialog(_ref) {
  ...
  }, trigger), jsx(DialogOverlay, _extends({
    css: css({
      position: "fixed",
      top: 0,
      left: 0,
