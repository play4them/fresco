import React__default, { useMemo, useRef, useEffect, forwardRef, createElement, Fragment, useState as useState$1, useCallback, PureComponent, cloneElement, Children, useLayoutEffect, Component as Component$2 } from 'react';
...
var Button = React__default.forwardRef(function (_ref) {
  ...
  return jsx(Text, _extends({
    ...
    css:
    /*#__PURE__*/
    css$2(_objectSpread2({}, buttonStyles(appearance, intent, useTheme()), {
      textDecoration: "none",
      userSelect: "none",
      appearance: "none",
      cursor: "pointer"
...
function BlurHash(_ref) {
  ...
  if (hash) {
    return jsx(React.Fragment, null, jsx("canvas", _extends({
      ref: blurRef,
      width: 32,
      height: 32,
      css:
...
var RemoveScrollBar = function (props) {
    var _a = useState$1(getGapWidth(props.gapMode)), gap = _a[0], setGap = _a[1];
    useEffect(function () {
...
function RemoveScrollSideCar(props) {
    ...
    var id = useState$1(idCounter++)[0];
    var Style = useState$1(function () { return styleSingleton(); })[0];
...
var useId = function useId(fallback) {
  ...
  var _useState = useState$1(initialId),
      id = _useState[0],
      setId = _useState[1];
...
var Tabs = forwardRef(function Tabs(_ref, ref) {
  ...
  var _useState = useState$1(defaultIndex || 0),
...
function useTooltip(_temp) {
  ...
  var _useState = useState$1(DEBUG_STYLE ? true : id === null ? false : context.id === id && state === VISIBLE),
