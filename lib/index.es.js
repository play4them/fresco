...
var Checkbox = function Checkbox(_ref) {
  ...
  return jsx(Text, {
    ...
    css: css(_objectSpread2({}, hideVisually(), {
      ...
      ":focus + div": {
        boxShadow: "inset 0 0 0 1px ".concat(theme.colors.blue[4], ", 0 0 1px ").concat(rgba(theme.colors.gray[4], 0.1), ", 0 1px 2px ").concat(rgba(theme.colors.gray[4], 0.1))
      }
    }))
  }, rest)), jsx(Box, {
