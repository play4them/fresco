...
const Button = React__default.forwardRef(function (_ref) {
  let {
    appearance,
    children,
    height,
  ...
  let getBorderRadiusForControlHeight = function (height) {
    if (height <= 32) return "3px";
    return "5px";
  };

  let getTextSizeForControlHeight = function (height) {
  ...
  let getIconSizeForButton = function (height) {
...
const getIconSizeForButton = function (height) {
...
const IconButton = function (_ref) {
  let {
    height,
    icon,
    label
...
function Alert$1(_ref) {
  ...
  const [open, setOpen] = useState(true); //when props update, force toast to reoopen, even if closed
...
const calculatePosition = function (side) {
  if (!side || side === "top") {
    return {
      top: "spacing.3",
      left: 0
...
const AspectRatio = function (_ref) {
  let {
    children,
    ratio
  } = _ref,
...
const getTextSizeForAvatarSize = function (size) {
...
const getControlSizeForTextSize = function (size) {
...
const InlineCodeSnippet = function ({
  children
}) {
  return jsx(Box, {
...
const MultiLineCodeSnippet = function ({
  children
}) {
  return jsx(Box, {
...
const CornerDialog = function (_ref) {
  let {
    buttonProps,
    children,
    title
...
const FormFieldDescription = function (_ref) {
  let {
    description
  } = _ref,
...
const FormFieldHint = function (_ref) {
  let {
    hint
  } = _ref,
...
const FormFieldLabel = function (_ref) {
  let {
    label
  } = _ref,
...
const FormFieldValidationMessage = function (_ref) {
  let {
    validationMessage
  } = _ref,
...
const getBorderRadiusForControlHeight = function (height) {
  if (height <= 40) return "3px";
  return "5px";
};

const getTextSizeForControlHeight = function (height) {
...
const getIconSizeForButton$1 = function (height) {
  if (height <= 32) return 16;
  if (height <= 40) return 20;
  if (height <= 48) return 24;
  return 24;
...
const FormFieldInput = function (_ref) {
  let {
    description,
    hint,
    inputProps,
...
const getControlSizeForTextSize$1 = function (size) {
  if (size <= 300) return 16;
  if (size <= 400) return 20;
  if (size <= 500) return 20;
  if (size <= 600) return 24;
...
const FormFieldRadioGroup = function (_ref) {
  let {
    description,
    hint,
    label,
...
const getBorderRadiusForControlHeight$1 = function (height) {
  if (height <= 40) return "3px";
  return "5px";
};

const getTextSizeForControlHeight$1 = function (height) {
  if (height <= 24) return 300;
  if (height <= 28) return 300;
  if (height <= 32) return 400;
  if (height <= 36) return 400;
...
const getIconSizeForButton$2 = function (height) {
...
const getBorderRadiusForControlHeight$2 = function (height) {
  if (height <= 40) return "3px";
  return "5px";
};

const getTextSizeForControlHeight$2 = function (height) {
  if (height <= 32) return 500;
  if (height <= 40) return 500;
  if (height <= 48) return 600;
  return 600;
...
const FormFieldTextarea = function (_ref) {
  let {
    description,
    hint,
    label,
...
const Toggle = function (_ref) {
  ...
  const getTextOffsetForTextSize = function (size) {
  ...
  const getControlOffsetForTextSize = function (size) {
